...
def gower_distance(data_x, data_y=None, alpha=1, weight=None, mix_features=None):
    X = data_x
    ...
    for i in range(n_rows_X):
        ...
        weighted_numeric_abs_power = weighted_numeric_abs ** alpha
        weighted_numeric_abs_sum = np.nansum(weighted_numeric_abs_power, axis=1)
